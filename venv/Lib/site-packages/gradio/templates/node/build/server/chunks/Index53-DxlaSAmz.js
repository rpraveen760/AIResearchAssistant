...
import { B as Block, S as Static, f as BlockLabel, y as File$1, h as Empty, U as UploadText, i as IconButtonWrapper, j as IconButton, J as Undo, k as Download } from './2-BBGSu8z1.js';
import { U as Upload, M as ModifyUpload } from './ModifyUpload-C5mToh5s.js';
...
async function loadCanvas3D$1() {
  const module = await import('./Canvas3D-KPqQQZrD.js');
  return module.default;
}
async function loadCanvas3DGS$1() {
  const module = await import('./Canvas3DGS-CqHzETY2.js');
  return module.default;
}
...
//# sourceMappingURL=Index53-DxlaSAmz.js.map

...
import { B as Block, S as Static, f as BlockLabel, Q as Code$2, h as Empty, j as IconButton, z as Copy$1, D as DownloadLink, k as Download$1, i as IconButtonWrapper } from './2-BBGSu8z1.js';
...
const lang_map = {
  python: () => import('./index29-BZf8ugKs.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index30-9ATe4do8.js'),
      import('./frontmatter-BkU-o530.js')
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => import('./index34-B2Z4VOsc.js').then((m) => m.json()),
  html: () => import('./index31-DjTIhJiC.js').then((m) => m.html()),
  css: () => import('./index32-CRWwePGD.js').then((m) => m.css()),
  javascript: () => import('./index33-BP3x9onp.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index33-BP3x9onp.js').then(
...
//# sourceMappingURL=Index13-C6-uPVbp.js.map

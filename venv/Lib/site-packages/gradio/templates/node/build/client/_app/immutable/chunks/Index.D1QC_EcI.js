const __vite__fileDeps=["./index.C6c646NX.js","./index.uEtc5SZ2.js","./index.B39xP_QZ.js","./index.CfT6hf4E.js","./index.C6yX03xB.js","./index.C_Vl78Kq.js","./frontmatter.CQ4ncB-g.js","./yaml.BMKOA8H-.js","./index.DSXNg1-q.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
...
import { I as IconButton, K as Check, N as Copy$1, B as Block, S as Static } from "./2.B3L4zow3.js";
...
const lang_map = {
  python: () => __vitePreload(() => import("./index.C6c646NX.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url).then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      __vitePreload(() => import("./index.B39xP_QZ.js"), true ? __vite__mapDeps([2,3,1,4,5]) : void 0, import.meta.url),
      __vitePreload(() => import("./frontmatter.CQ4ncB-g.js"), true ? __vite__mapDeps([6,7]) : void 0, import.meta.url)
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => __vitePreload(() => import("./index.DSXNg1-q.js"), true ? __vite__mapDeps([8,1]) : void 0, import.meta.url).then((m) => m.json()),
  html: () => __vitePreload(() => import("./index.CfT6hf4E.js"), true ? __vite__mapDeps([3,1,4,5]) : void 0, import.meta.url).then((m) => m.html()),
  css: () => __vitePreload(() => import("./index.C6yX03xB.js"), true ? __vite__mapDeps([4,1]) : void 0, import.meta.url).then((m) => m.css()),
  javascript: () => __vitePreload(() => import("./index.C_Vl78Kq.js"), true ? __vite__mapDeps([5,1]) : void 0, import.meta.url).then((m) => m.javascript()),
  jinja2: () => __vitePreload(() => import("./jinja2.2Vo2sGef.js"), true ? [] : void 0, import.meta.url).then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => __vitePreload(() => import("./index.C_Vl78Kq.js"), true ? __vite__mapDeps([5,1]) : void 0, import.meta.url).then(
